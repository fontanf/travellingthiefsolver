...
template <typename Instance>
std::vector<std::vector<packingwhiletravellingsolver::CityState>> packingwhiletravellingsolver::compute_city_states(
        const Instance &instance)
{
...
template <typename Instance, typename Solution>
std::vector<packingwhiletravellingsolver::CityStateId> packingwhiletravellingsolver::solution2states(
        const Instance& instance,
        const std::vector<std::vector<CityState>>& city_states,
        const Solution& solution)
{
