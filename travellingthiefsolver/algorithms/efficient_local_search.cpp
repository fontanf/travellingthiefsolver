...
using CityState = packingwhiletravellingsolver::CityState;
...
EfficientLocalSearchOutput travellingthiefsolver::efficient_local_search(
        const Instance& instance,
        std::mt19937_64& generator,
        EfficientLocalSearchOptionalParameters parameters)
{
...
EfficientLocalSearchOutput travellingthiefsolver::efficient_genetic_local_search(
        const Instance& instance,
        std::mt19937_64& generator,
        EfficientLocalSearchOptionalParameters parameters)
{
