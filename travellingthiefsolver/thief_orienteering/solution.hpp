...
/**
 * Solution class for a 'thief_orienteering' problem.
 */
class Solution
{
    ...
    items_is_selected_(instance.number_of_items(), false)
{
    ...
    distance_ = distance_cur_ + distances.distance(
            0,
        ...
        CityId city_id)
{
    ...
    if (cities_[city_id].in) {
        throw std::runtime_error(
                "thief_orienteering::Solution::add_city(CityId)."
