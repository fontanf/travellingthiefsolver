#include "travellingthiefsolver/travellingthief/algorithms/large_neighborhood_search.hpp"
        ...
        LargeNeighborhoodSearchParameters parameters)
{
    ...
    for (output.number_of_iterations = 0;; ++output.number_of_iterations) {
        ...
        for (const TwoOptMove& two_opt_move: two_opt_moves) {
            ...
            packingwhiletravelling::Solution pwt_initial_solution(
                    pwt_instance,
                    pwt_initial_items);
            ...
            auto pwt_output = packingwhiletravelling::efficient_local_search(
                    pwt_instance,
                    pwtels_parameters);
